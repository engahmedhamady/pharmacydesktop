...
public class DeliveryBillsDAO implements commonDAO<DeliveryBills> {
    ...
    public DeliveryBills update(DeliveryBills deliveryBills) {
        ...
        try {
            conn = DBConnectionManager.getConnection();
            stmt = conn.prepareStatement("UPDATE `delivery_bills` SET `Drug1`=?,`unit_price1`=?,`Quantity1`=?,`total1`=?,`discount1`=?,`net1`=?,`profit1`=?,`Drug2`=?,"
    ...
    public void remove(Object billCode) {
        DeliveryBills bills = (DeliveryBills) billCode;
        ...
        try {
            conn = DBConnectionManager.getConnection();
            stmt = conn.prepareStatement("DELETE  FROM `delivery_bills` WHERE bill_code = ?   ");
    ...
    public DeliveryBills findById(Object billCode) {
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        DeliveryBills bills = null;
        try {
            conn = DBConnectionManager.getConnection();
            stmt = conn.prepareStatement("SELECT * FROM `delivery_bills` WHERE bill_code = ? ");
            stmt.setInt(1, (int) billCode);
            rs = stmt.executeQuery();
            if (rs.next()) {
                bills = new DeliveryBills();
    ...
    public List<DeliveryBills> findList() {
        ...
        ResultSet rs = null;
        DeliveryBills bills = null;
         List<DeliveryBills> l = new ArrayList<>();
        try {
            conn = DBConnectionManager.getConnection();
            stmt = conn.prepareStatement("SELECT * FROM `delivery_bills` WHERE  1 ");
